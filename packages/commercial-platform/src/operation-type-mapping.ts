...
const VERTICAL_TO_OPERATION_TYPE: Record<string, BusinessOperationType> = {
  ...
  "water-tank-truck": "water_tank_service",
  "sand-gravel-transport": "bulk_material_transport",
  "concrete-mixer-truck": "concrete_mixer_service",
...
const OPERATION_TYPE_LABEL_PT: Record<BusinessOperationType, string> = {
  ...
  bulk_material_transport: "Transporte de areia e pedra",
  concrete_mixer_service: "Caminhão betoneira / concreto",
