...
// real credentials configured. Same Firebase project as apps/web (spec item
// 25: no second Firebase project/identity pool) — mirrored here rather than
// imported from apps/web since each app owns its own server-only lib/.
