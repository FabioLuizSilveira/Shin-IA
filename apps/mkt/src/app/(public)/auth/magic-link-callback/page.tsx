...
// actionCodeSettings.url every link sent by /login's handleFirebaseMagicLink
// points at. Mirrors apps/web's identical page, kept separate from
// /api/auth/callback (Supabase's own PKCE exchange) so neither flow can
// interfere with the other's query-string/fragment parsing.
