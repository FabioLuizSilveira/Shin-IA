            ...
            <div className="card-glass rounded-2xl p-5 ring-1 ring-mkt-primary/30">
              ...
              {result.notes && (
                <div className="mt-3 rounded-xl bg-slate-100 dark:bg-white/5 p-3">
                  ...
                  <p className="text-xs text-slate-700 dark:text-slate-300">{result.notes}</p>
                </div>
              )}
                  ...
                  <div key={clone.id} className="card-glass rounded-xl p-4">
                    ...
                    {clone.source_url && (
                      <a
                        ...
                        className="text-[10px] text-slate-500 hover:text-slate-900 dark:hover:text-white mt-2 inline-block no-underline"
                      >
