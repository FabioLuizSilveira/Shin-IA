// M22 — ported verbatim from the Emergent frontend
// (frontend/src/theme.ts on origin/feat/emergent-mobile-integration), the
// design foundation the ADR designates as primary visual reference for the
// tenant_user experience. Token values unchanged.
export const theme = {
  colors: {
