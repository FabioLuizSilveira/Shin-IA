        ...
        <div className="border-t border-slate-100 dark:border-slate-800 px-5 pb-5 pt-4">
          <div className="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition"
            >
      ...
      <div className="max-w-4xl">
        ...
        <div className="flex items-start justify-between mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-sm font-semibold rounded-xl shadow-sm disabled:opacity-60 transition"
          >
            {generating ? (
              <>
