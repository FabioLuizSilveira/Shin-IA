...
import type { ResourceDetail as ResourceDetailData, ResourceStatus, ResourceType } from "@/types/domain";
                    ...
                    {resource.recent_operations.map((op) => (
                      ...
                      >
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-slate-500">{formatDate(op.scheduled_starts_at)}</p>
                        </div>
